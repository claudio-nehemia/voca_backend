    ...
    <div class="modal-content">
        <form action="" method="POST" id="editForm">
            ...
            <div class="modal-header">
                <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--text-main); margin: 0;">Ubah Writing</h3>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div id="edit-theme-select-container">
                        <select name="writing_theme_id" id="edit-theme-id" class="form-control" onchange="checkEditNewTheme(this)">
                    ...
                    <div id="edit-new-theme-container" style="display: none; margin-top: 0.75rem; background: #f8fafc; padding: 1rem; border-radius: 0.75rem; border: 1px dashed var(--border-color);">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <input type="text" name="new_theme" id="edit-new-theme-input" class="form-control" placeholder="Contoh: Descriptive Text">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="edit-title" class="form-control" placeholder="e.g., Essay, Story Writing" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="instruction" id="edit-instruction" class="form-control" rows="5" placeholder="Tulis instruksi lengkap untuk soal writing..." required></textarea>
                </div>
            </div>
...
<script>
    ...
    function cancelEditNewTheme() {
        ...
        // We'll reset it to "none" or something later if we have the original value
