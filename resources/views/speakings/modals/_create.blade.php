...
<div id="createModal" class="modal">
    <div class="modal-content">
        <form action="{{ route('speakings.store') }}" method="POST" id="createForm">
            @csrf
            <div class="modal-header">
                <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--text-main); margin: 0;">Tambah Speaking Baru</h3>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div id="theme-select-container">
                        <select name="jenis_speaking_id" id="theme-select" class="form-control" onchange="checkNewTheme(this)">
                    ...
                    <div id="new-theme-container" style="display: none; margin-top: 0.75rem; background: #f8fafc; padding: 1rem; border-radius: 0.75rem; border: 1px dashed var(--border-color);">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <input type="text" name="new_jenis_speaking" id="new-theme-input" class="form-control" placeholder="Contoh: Pronunciation">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="e.g., Introduce Yourself" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="instruction" class="form-control" rows="5" placeholder="Tulis instruksi lengkap untuk soal speaking..." required></textarea>
                </div>
            </div>
